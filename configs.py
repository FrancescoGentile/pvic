...
def base_detector_args():
    ...
    parser.add_argument(
        "--position-embedding", default="sine", type=str, choices=("sine", "learned")
    )
    ...
    parser.add_argument("--lr-drop-factor", default=0.2, type=float)
    ...
    parser.add_argument(
        "--partitions", nargs="+", default=["train2015", "test2015"], type=str
    )
    parser.add_argument("--num-workers", default=2, type=int)
    parser.add_argument("--data-root", default="./hicodet")
    parser.add_argument("--output-dir", default="checkpoints")
    parser.add_argument(
        "--pretrained", default="", help="Path to a pretrained detector"
    )
...
def advanced_detector_args():
    ...
    parser.add_argument(
        "--num-feature-levels", default=4, type=int, help="number of feature levels"
    )
    ...
    parser.add_argument(
        "--no-box-refine", dest="with_box_refine", default=True, action="store_false"
    )
    parser.add_argument(
        "--no-two-stage", dest="two_stage", default=True, action="store_false"
    )

    # Tricks
    parser.add_argument(
        "--no-mixed-selection",
        dest="mixed_selection",
        action="store_false",
        default=True,
    )
    parser.add_argument(
        "--no-look-forward-twice",
        dest="look_forward_twice",
        action="store_false",
        default=True,
    )
    ...
    # Training
    parser.add_argument("--lr-head", default=1e-4, type=float)
    parser.add_argument("--lr-backbone", default=0.0, type=float)
    parser.add_argument("--lr-drop", default=20, type=int)
    parser.add_argument("--lr-drop-factor", default=0.2, type=float)
    parser.add_argument("--epochs", default=30, type=int)
    parser.add_argument("--batch-size", default=16, type=int)
